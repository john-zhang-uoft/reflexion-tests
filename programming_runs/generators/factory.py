...
from .model import CodeLlama, ModelBase, GPT4, GPT35, StarChat, GPTDavinci, OpenAI_API_Chat_Model
...
def model_factory(model_name: str, base_url: Optional[str] = None) -> ModelBase:
    if model_name == "gpt-4":
        return GPT4()
    elif model_name == "gpt-3.5-turbo":
        return GPT35()
    elif base_url is not None:
        return OpenAI_API_Chat_Model(model_name, base_url)
